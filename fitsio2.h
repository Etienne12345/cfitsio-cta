...
int fits_ctadecomp(unsigned char* c, unsigned long input_len, unsigned char array[], unsigned long output_size, int col_type, int col_width, unsigned long long col_zero);
